...
// Checkin What level user has permission to view this page
 page_require_level(require_level: 1);
      ...
      <table class="table table-bordered table-striped">
        ...
        <?php foreach($all_users as $a_user): ?>
          <tr>
           ...
           <td class="text-center"><?php echo remove_junk(ucwords(string: $a_user['group_name']))?></td>
          ...
          <?php endif;?>
           ...
           <td><?php echo read_date(str: $a_user['last_login']); ?></td>
           <td class="text-center">
             <div class="btn-group">
