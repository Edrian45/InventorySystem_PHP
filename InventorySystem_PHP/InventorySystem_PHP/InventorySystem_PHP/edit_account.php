  ...
  <div class="col-md-6">
      <div class="panel panel-default bg-blue">
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-md-4">
                <img class=" img-size-2" src="uploads/users/<?php echo $user['image'];?>" alt="">
            </div>
            <div class="col-md-8">
              <form class="form" action="edit_account.php" method="POST" enctype="multipart/form-data">
              <div style="color:black;" class="form-group">
                <p>Upload Image</p>
                <input style="border:1px solid black; background-color: green; color:white;"  type="file" placeholder="Upload Image" name="file_upload" multiple="multiple" class="btn btn-default btn-file"/>
              </div>
